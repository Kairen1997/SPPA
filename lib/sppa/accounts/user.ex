defmodule Sppa.Accounts.User do
  use Ecto.Schema
  ...
  It requires no_kp and password to be set.
  """
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Sppa.Repo)
  ...
  """
  def valid_password?(%Sppa.Accounts.User{hashed_password: hashed_password}, password)
