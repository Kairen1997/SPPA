defmodule SppaWeb.Components.Sidebar do
  ...
  attr :desktop_sidebar_visible, :boolean, default: true, doc: "Whether the sidebar is visible on desktop"
  attr :current_path, :string, default: "/dashboard", doc: "Current path for active link highlighting"
      ...
      <aside class={[
        ...
        <nav class="mt-4 flex-1 text-sm">
          ...
          >
            <.icon
              name="hero-home"
              class={if(@current_path == "/dashboard", do: "h-5 w-5 text-yellow-300", else: "h-5 w-5 text-gray-300")}
            />
            <span>Dashboard</span>
          </.link>
