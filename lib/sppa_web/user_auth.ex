defmodule SppaWeb.UserAuth do
  use SppaWeb, :verified_routes
  ...
  @remember_me_cookie "_sppa_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      SppaWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      SppaWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule SppaWeb.PageLive do
        use SppaWeb, :live_view

        on_mount {SppaWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{SppaWeb.UserAuth, :require_authenticated}] do
    ...
    cond do
        ...
        if user_role && user_role in allowed_roles do
          ...
          socket =
            ...
            |> Phoenix.LiveView.put_flash(
              :error,
              "You do not have permission to access this page. Your role: #{user_role || "not set"}"
            )
            |> Phoenix.LiveView.redirect(to: ~p"/users/log-in")
      ...
      true ->
        socket =
          ...
          |> Phoenix.LiveView.put_flash(
            :error,
            "You do not have permission to access this page. Please contact administrator to set your role."
          )
          |> Phoenix.LiveView.redirect(to: ~p"/users/log-in")
